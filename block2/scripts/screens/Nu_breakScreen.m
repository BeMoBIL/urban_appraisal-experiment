...
%   Draws a break screen for the specified amount of time.
    ...
    if strcmp(language, 'english')
        breakText = 'Taking a short break. The person responsible will join you shortly.';
    else
        breakText = 'Sie machen eine kurze Pause. Die zustaendige Person wird in Kuerze zu Ihnen kommen.';
    end
